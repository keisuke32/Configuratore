...
$.widget( "kf." + wizard, {
	...
	_update: function( event, state ) {
		...
		{
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val());
		}
		if(state.stepIndex == 2)
		{
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val() + " > " + jQuery("#selected_gender_type_name").val());
		}
		if(state.stepIndex == 3)
		{
			...
			if(parseInt(jQuery("#total_order_count").val()) > 1)
				jQuery("#backward").hide();
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val() + " > " + jQuery("#selected_gender_type_name").val() + " > " + jQuery("#selected_brand_type_name").val());
			...
			$.ajax({
		        ...
		        success: function(res){
		        		...
		        		(JSON.parse(res).rapp_pants == 0 && JSON.parse(res).rapp_socks == 0))
		        	{
		        		...
		        		jQuery("#unavailable_typology_name").html("<b>Rappresentanza</b>");
		        		...
		        		(JSON.parse(res).campo_pants == 0 && JSON.parse(res).campo_socks == 0))
		        	{
		        		...
		        		if(jQuery("#unavailable_typology_name").html() == "")
		        			jQuery("#unavailable_typology_name").html("<b>Campo</b>");
		        		else
		        			jQuery("#unavailable_typology_name").html(jQuery("#unavailable_typology_name").html() + ", <b>Campo</b>");
		        		jQuery("#unavailable_typology").css('display', 'inline');
		        	}
		        	else
		        	{
		        		...
		        		(JSON.parse(res).allen_pants == 0 && JSON.parse(res).allen_socks == 0))
		        	{
		        		...
		        		if(jQuery("#unavailable_typology_name").html() == "")
		        			jQuery("#unavailable_typology_name").html("<b>Allenamento</b>");
		        		else
		...
		{
			// alert(jQuery("#selected_typology_type_" + jQuery("#total_order_count").val()).val());
			...
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val() + " > " + jQuery("#selected_gender_type_name").val() + " > " + jQuery("#selected_brand_type_name").val() + " > " + jQuery("#selected_typology_type_name_" + jQuery("#total_order_count").val()).val());
			jQuery("input[name=clothes_type]").prop('checked', false);
			if(jQuery("#selected_t_shirt_type_" + jQuery("#total_order_count").val()).val() == "")
			{
				jQuery("#shirt_clothes").removeAttr('disabled');
				jQuery("#label_shirt_clothes").css({opacity: 1});
				jQuery("#label_shirt_clothes").css('cursor', 'pointer');
			}else {
				jQuery("#shirt_clothes").attr('disabled','disabled');
        		jQuery("#label_shirt_clothes").css({opacity: 0.5});
        		jQuery("#label_shirt_clothes").css('cursor', 'not-allowed');
			}
			if(jQuery("#selected_pants_type_" + jQuery("#total_order_count").val()).val() == "")
			{
				jQuery("#pants_clothes").removeAttr('disabled');
				jQuery("#label_pants_clothes").css({opacity: 1});
				jQuery("#label_pants_clothes").css('cursor', 'pointer');
			}else {
				jQuery("#pants_clothes").attr('disabled','disabled');
        		jQuery("#label_pants_clothes").css({opacity: 0.5});
        		jQuery("#label_pants_clothes").css('cursor', 'not-allowed');
			}
			if(jQuery("#selected_socks_type_" + jQuery("#total_order_count").val()).val() == "")
			{
				jQuery("#socks_clothes").removeAttr('disabled');
				jQuery("#label_socks_clothes").css({opacity: 1});
				jQuery("#label_socks_clothes").css('cursor', 'pointer');
			}else {
				jQuery("#socks_clothes").attr('disabled','disabled');
        		jQuery("#label_socks_clothes").css({opacity: 0.5});
        		jQuery("#label_socks_clothes").css('cursor', 'not-allowed');
			}
			if(jQuery("#selected_t_shirt_type_" + jQuery("#total_order_count").val()).val() == "" && jQuery("#selected_pants_type_" + jQuery("#total_order_count").val()).val() == "" && jQuery("#selected_socks_type_" + jQuery("#total_order_count").val()).val() == "")
			{
				jQuery("#backward").show();
			} else {
				jQuery("#backward").hide();
		...
		{
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val() + " > " + jQuery("#selected_gender_type_name").val() + " > " + jQuery("#selected_brand_type_name").val() + " > " + jQuery("#selected_typology_type_name_" + jQuery("#total_order_count").val()).val() + " > Maglie");
			$("#select_t_shirt").html("");
		...
		if(state.stepIndex == 6)
		{
			...
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val() + " > " + jQuery("#selected_gender_type_name").val() + " > " + jQuery("#selected_brand_type_name").val() + " > " + jQuery("#selected_typology_type_name_" + jQuery("#total_order_count").val()).val() + " > Maglie > " + jQuery("#selected_t_shirt_type_name_" + jQuery("#total_order_count").val()).val());
			if(jQuery("#selected_t_shirt_type_" + jQuery("#total_order_count").val()).val())
			{
		...
		{
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val() + " > " + jQuery("#selected_gender_type_name").val() + " > " + jQuery("#selected_brand_type_name").val() + " > " + jQuery("#selected_typology_type_name_" + jQuery("#total_order_count").val()).val() + " > Pantaloni");
			$("#select_pants").html("");
		...
		if(state.stepIndex == 8)
		{
			jQuery("#cart_alarm").html(parseInt(jQuery("#cart_alarm").html()) + 1);
			jQuery("#tocartpage").show();
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val() + " > " + jQuery("#selected_gender_type_name").val() + " > " + jQuery("#selected_brand_type_name").val() + " > " + jQuery("#selected_typology_type_name_" + jQuery("#total_order_count").val()).val() + " > Pantaloni > " + jQuery("#selected_pants_type_name_" + jQuery("#total_order_count").val()).val());
			if(jQuery("#selected_pants_type_" + jQuery("#total_order_count").val()).val())
			{
				jQuery("body").css('background-image', 'none');
				var param = {
		...
		{
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val() + " > " + jQuery("#selected_gender_type_name").val() + " > " + jQuery("#selected_brand_type_name").val() + " > " + jQuery("#selected_typology_type_name_" + jQuery("#total_order_count").val()).val() + " > Calze");
			$("#select_socks").html("");
		...
		if(state.stepIndex == 10)
		{
			jQuery("#cart_alarm").html(parseInt(jQuery("#cart_alarm").html()) + 1);
			jQuery("#tocartpage").show();
			jQuery(".breadcrumb_text").html(jQuery("#selected_sport_type_name").val() + " > " + jQuery("#selected_gender_type_name").val() + " > " + jQuery("#selected_brand_type_name").val() + " > " + jQuery("#selected_typology_type_name_" + jQuery("#total_order_count").val()).val() + " > Calze > " + jQuery("#selected_socks_type_name_" + jQuery("#total_order_count").val()).val());
			if(jQuery("#selected_socks_type_" + jQuery("#total_order_count").val()).val())
			{
				jQuery("body").css('background-image', 'none');
				var param = {
		...
		if(state.stepIndex == 11) {
			...
			var str_order_summary = '<div class="row">' +
										'<div class="col-12">' +
										'<p class="orderp">Brand: <b>' + str_arr[$("#selected_brand_type").val()] + '</b></p>'+
										'<p class="orderp">Sport: <b>' + str_arr[$("#selected_sport_type").val()] + '</b></p>'+
										'<p class="orderp">Tipologia: <b>' + str_arr[jQuery("#selected_typology_type_" + jQuery("#total_order_count").val()).val()] + '</b></p>'+
										'<p class="orderp">Gender: <b>' + str_arr[$("#selected_gender_type").val()] + '</b></p><br><br>'+
										'</div>'+
									'</div>'+
									'<div class="row">';
			if(jQuery("#selected_t_shirt_type_" + jQuery("#total_order_count").val()).val())
			{						
				str_order_summary +=		'<div class="col-md-6" style="padding-top: 20px;">' +
												'<p class="orderp">Prodotto: <b>Maglia</b></p>'+
												'<p class="orderp">Nome Prodotto: <b>' + $("#selected_t_shirt strong").html() + '</b></p>'+
												'<p class="orderp">Codice Prodotto: <b>' + $("#selected_t_shirt span.item_price").html() + '</b></p>';
			...
			{
				str_order_summary +=	'<div class="col-md-6" style="padding-top: 20px;">'+
												'<p class="orderp">Prodotto: <b>Pantalone</b></p>'+
												'<p class="orderp">Nome Prodotto: <b>' + $("#selected_pants strong").html() + '</b></p>'+
												'<p class="orderp">Codice Prodotto: <b>' + $("#selected_pants span.item_price").html() + '</b></p>';
			...
			{
				str_order_summary +=	'<div class="col-md-6" style="padding-top: 20px;">' +
											'<p class="orderp">Prodotto: <b>Calze</b></p>'+
											'<p class="orderp">Nome Prodotto: <b>' + $("#selected_socks strong").html() + '</b></p>'+
											'<p class="orderp">Codice Prodotto: <b>' + $("#selected_socks span.item_price").html() + '</b></p>';
			...
			{
				var shirt_detail = {};
				shirt_detail["name"] = $("#selected_t_shirt strong").html();
				shirt_detail["sku"] = $("#selected_t_shirt span.item_price").html();
	    	...
	    	{
		        var pants_detail = {};
				pants_detail["name"] = $("#selected_pants strong").html();
				pants_detail["sku"] = $("#selected_pants span.item_price").html();
	    	...
	    	{
		        var socks_detail = {};
				socks_detail["name"] = $("#selected_socks strong").html();
				socks_detail["sku"] = $("#selected_socks span.item_price").html();
			...
			function redraw(){
				...
				{
					if(jQuery("#selected_pants_type_" + jQuery("#total_order_count").val()).val())
						ctx.drawImage(image2, 0, canvas.height/3, canvas.width/1.25, canvas.height/2.8);
					if(jQuery("#selected_socks_type_" + jQuery("#total_order_count").val()).val())
						ctx.drawImage(image3, canvas.width/4, canvas.height/1.45, canvas.width/3, canvas.height/5);
					ctx.drawImage(image4, canvas.width/6,canvas.height/3,canvas.width/2,canvas.width/4.7);
				}
				else
				{
					if(jQuery("#selected_pants_type_" + jQuery("#total_order_count").val()).val())
						ctx.drawImage(image2, canvas.width/6.5, canvas.height/3, canvas.width/2.2, canvas.height/5);
					if(jQuery("#selected_socks_type_" + jQuery("#total_order_count").val()).val())
						ctx.drawImage(image3, canvas.width/5, canvas.height/1.85, canvas.width/3, canvas.height/5);
					ctx.drawImage(image4, canvas.width/6,canvas.height/4,canvas.width/2,canvas.width/4.7);
				}
			}
			...
			if(jQuery("#selected_t_shirt_type_" + jQuery("#total_order_count").val()).val())
			{
				...
				image1.src = jQuery("#selected_t_shirt img").attr('src');
			}
			if(jQuery("#selected_pants_type_" + jQuery("#total_order_count").val()).val())
			{
				image2.crossOrigin = "anonymous";
				image2.src   = jQuery("#selected_pants img").attr('src');
			}
			if(jQuery("#selected_socks_type_" + jQuery("#total_order_count").val()).val())
			{
				image3.crossOrigin = "anonymous";
				image3.src   = jQuery("#selected_socks img").attr('src');
			}
			image4.crossOrigin = "anonymous";
			image4.src   = "https://www.amministrazionedigitale.org/ggteamwear/configuratore/img/watermark.png";
			...
			function incrementCounter() {
			    ...
			    if ( counter == imgs.length ) {
					...
					// setTimeout(function (){
		        		...
		        		tempCanvas.width = canvas.width/13.5 + canvas.width/1.5 + canvas.width/13.5;
		        		if($("#selected_pants input#is_long_pants").val() == "true")
		        			tempCanvas.height = canvas.height/3 + canvas.height/2.8 + canvas.height/5;
		        		else
		        			tempCanvas.height = canvas.height/3 + canvas.height/5 + canvas.height/5 + 30;
						...
						$.ajax({
						    ...
						    success: function(response) {
								...
								if(jQuery("#selected_main_canvas_file_name_1").val())
								{
									...
									final_image1.src = "https://www.amministrazionedigitale.org/ggteamwear/configuratore/image-kit/canvasImage-" + jQuery("#email").val() + "-" + jQuery("#selected_main_canvas_file_name_1").val() + ".png";
									totalLoaded ++;
								}
								...
								if(jQuery("#selected_main_canvas_file_name_2").val())
								{
									...
									final_image2.src = "https://www.amministrazionedigitale.org/ggteamwear/configuratore/image-kit/canvasImage-" + jQuery("#email").val() + "-" + jQuery("#selected_main_canvas_file_name_2").val() + ".png";
									totalLoaded ++;
								}
								...
								if(jQuery("#selected_main_canvas_file_name_3").val())
								{
									...
									final_image3.src = "https://www.amministrazionedigitale.org/ggteamwear/configuratore/image-kit/canvasImage-" + jQuery("#email").val() + "-" + jQuery("#selected_main_canvas_file_name_3").val() + ".png";
									totalLoaded ++;
								}
								var nloaded = 0;
		...
		if(state.stepIndex == 12) {
			...
			for(var i=1;i<=3;i++)
			{
				if(jQuery("#selected_t_shirt_type_" + i).val() || jQuery("#selected_pants_type_" + i).val() || jQuery("#selected_socks_type_" + i).val())
					jQuery("#order_product_list").html(jQuery("#order_product_list").html() +
													'<div class="question_title order_title_' + i + '">' + 
														'<h4>Configurazione ' + i + '</h4>' + 
													'</div>');
					...
					jQuery("#order_product_list").html(jQuery("#order_product_list").html() + 
						'<div class="row justify-content-center cart_product shirts_product_' + i + '">' + 
							...
							'<div class="col-md-8 cart_product_description mb-4">' + 
								'<h5>' + jQuery("#selected_shirts_name_" + i).val() + '</h5>' + 
								'<div class="row product_category">' + 
									'<div class="col-md-5 col-6">' + 
										'<p>Prodotto: <b>Maglia</b></p>' + 
										'<p>Nome Prodotto: <b>' + jQuery("#selected_shirts_name_" + i).val() + '</b></p>' + 
										'<p>Codice Prodotto: <b>' + jQuery("#selected_t_shirt_type_name_" + i).val() + '</b></p>' + 
									'</div>' + 
									'<div class="col-md-5 col-6">' + 
										'<p>Brand: <b>' + $("#selected_brand_type_name").val() + '</b></p>' + 
										'<p>Sport: <b>' + $("#selected_sport_type_name").val() + '</b></p>' + 
										'<p>Tipologia: <b>' + $("#selected_typology_type_name_" + i).val() + '</b></p>' + 
										'<p>Gender: <b>' + $("#selected_gender_type_name").val() + '</b></p>' + 
									'</div>' + 
								'</div>' + 
							'</div>' + 
							'<div class="col-md-2 col-12 cart_product_action d-block m-auto text-center">' + 
								'<button type="button" onclick="remove_product('+ i + ', 1)"><span>X</span>&nbsp;&nbsp;&nbsp;Rimuovi</button>' + 
							'</div>' + 
						'</div>');
				}
				if(jQuery("#selected_pants_type_" + i).val())
				{
					jQuery("#order_product_list").html(jQuery("#order_product_list").html() + 
						'<div class="row justify-content-center cart_product pants_product_' + i + '">' + 
							'<div class="col-md-2 col-12 mb-4 cart_product_image">' + 
								'<img class="img-fluid" src="' + jQuery("#selected_pants_img_" + i).val() + '">' + 
							'</div>' + 
							'<div class="col-md-8 cart_product_description mb-4">' + 
								'<h5>' + jQuery("#selected_pants_name_" + i).val() + '</h5>' + 
								'<div class="row product_category">' + 
									'<div class="col-md-5 col-6">' + 
										'<p>Prodotto: <b>Pantalone</b></p>' + 
										'<p>Nome Prodotto: <b>' + jQuery("#selected_pants_name_" + i).val() + '</b></p>' + 
										'<p>Codice Prodotto: <b>' + jQuery("#selected_pants_type_name_" + i).val() + '</b></p>' + 
									'</div>' + 
									'<div class="col-md-5 col-6">' + 
										'<p>Brand: <b>' + $("#selected_brand_type_name").val() + '</b></p>' + 
										'<p>Sport: <b>' + $("#selected_sport_type_name").val() + '</b></p>' + 
							...
							'</div>' + 
							'<div class="col-md-2 col-12 cart_product_action d-block m-auto text-center">' + 
								'<button type="button" onclick="remove_product('+ i + ', 2)"><span>X</span>&nbsp;&nbsp;&nbsp;Rimuovi</button>' + 
							'</div>' + 
						'</div>');
				}
				if(jQuery("#selected_socks_type_" + i).val())
				{
					jQuery("#order_product_list").html(jQuery("#order_product_list").html() + 
						'<div class="row justify-content-center cart_product socks_product_' + i + '">' + 
							'<div class="col-md-2 col-12 mb-4 cart_product_image">' + 
								'<img class="img-fluid" src="' + jQuery("#selected_socks_img_" + i).val() + '">' + 
							'</div>' + 
							'<div class="col-md-8 cart_product_description mb-4">' + 
								'<h5>' + jQuery("#selected_socks_name_" + i).val() + '</h5>' + 
								'<div class="row product_category">' + 
									'<div class="col-md-5 col-6">' + 
										'<p>Prodotto: <b>Calze</b></p>' + 
										'<p>Nome Prodotto: <b>' + jQuery("#selected_socks_name_" + i).val() + '</b></p>' + 
										'<p>Codice Prodotto: <b>' + jQuery("#selected_socks_type_name_" + i).val() + '</b></p>' + 
									'</div>' + 
									'<div class="col-md-5 col-6">' + 
										'<p>Brand: <b>' + $("#selected_brand_type_name").val() + '</b></p>' + 
										'<p>Sport: <b>' + $("#selected_sport_type_name").val() + '</b></p>' + 
							...
							'</div>' + 
							'<div class="col-md-2 col-12 cart_product_action d-block m-auto text-center">' + 
								'<button type="button" onclick="remove_product('+ i + ', 3)"><span>X</span>&nbsp;&nbsp;&nbsp;Rimuovi</button>' + 
							'</div>' + 
						'</div>');
				}
				if(jQuery("#selected_t_shirt_type_" + i).val() || jQuery("#selected_pants_type_" + i).val() || jQuery("#selected_socks_type_" + i).val())
					jQuery("#order_product_list").html(jQuery("#order_product_list").html() + 
													'<div style="text-align: center;" class="btn_remove_product_' + i + '">' + 
														'<button type="button" class="remove_order" onclick="remove_order(' + i + ')">Elimina Configurazione ' + i + '</button>' +
													'</div>');
			}
		}
	},
	...
	backward: function( event, howMany ) {
		...
		if(this._currentState.stepIndex == 5)
		{
			jQuery("#selected_t_shirt_type_" + jQuery("#total_order_count").val()).val("");
			howMany = 1;
		}
	...
	forward: function( event, howMany, history ) {
		...
		if(this._currentState.stepIndex == 6)
			howMany = -2;
		else if(this._currentState.stepIndex == 8)
			howMany = -4;
		else if(this._currentState.stepIndex == 10)
